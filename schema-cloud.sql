...
-- Variante de schema.sql para proveedores cloud (Aiven, Railway, etc.)
-- No incluye DROP DATABASE / CREATE DATABASE / USE, porque en esos servicios
-- la base ya viene creada y el usuario no siempre puede crear otras.
-- Ejecute este archivo CONECTADO a la base que le entregó el proveedor.
